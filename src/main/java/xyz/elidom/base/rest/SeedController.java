...
public class SeedController implements InitialSetup {
	...
	private Map<String, Object> buildInitialParams(Environment env) {
		...
		seedParams.put("token",	BeanUtil.get(MessageDigestPasswordEncoder.class).encodePassword((String) seedParams.get("domain_name"), null));
		return seedParams;
	}
	...
	private void assertValidToken(String token, String encryptSource) {
		String encrypted = BeanUtil.get(MessageDigestPasswordEncoder.class).encodePassword(encryptSource, null);
