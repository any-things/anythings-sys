...
@Table(name = "error_logs", idStrategy = GenerationRule.UUID, indexes = {
	...
	@Index(name = "ix_err_log_2", columnList = "domain_id,message"),
	@Index(name = "ix_err_log_3", columnList = "domain_id,error_type"),
	@Index(name = "ix_err_log_4", columnList = "domain_id,uri"),
	@Index(name = "ix_err_log_5", columnList = "domain_id,issue_date")
})
